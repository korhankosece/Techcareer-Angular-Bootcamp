...
//en çok harcama yapan müşteri kimdir ve ne kadar harcadı => best customer?

// let customerTotalPrice = [];

// orders.forEach((order) => {
//     if (order.details) {
//         let obj = { id: order.customerId, totalPrice: 0 }
...
//         const isCustomerExist = customerTotalPrice.length > 0 ? customerTotalPrice.some(q => q.id === order.customerId) : null;
...
// const bestCustomer = customerTotalPrice.sort((a, b) => a.totalPrice - b.totalPrice).reverse()[0].id
...
//     if (formattedDate.getFullYear() === 1997 && formattedDate.getMonth() === 1) {
//         console.log(order);
//     }
// })