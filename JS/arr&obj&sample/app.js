...
// for of async işlemlerde kullanılabilir
for (const product of products) {
    // console.log(product);
}

for (const [productIndex, productx] of products.entries()) {
    // console.log(productIndex, productx);
}
...
// const loopFunction = (product) => {
//     console.log(product);
// }

// products.forEach(loopFunction)
...
const product = products.find(q => q.id === 18)
const product2 = products.filter(q => q.id === 18)[0]

products.sort((a, b) => a.supplierId - b.supplierId).reverse();
